...
function agregarNumeros(numeros) {
  ...
  // Tu código:
  return numeros.reduce((acc, elem) => acc + elem, 0);
...
function cuentoElementos(arreglo){
  ...
  return arreglo.filter(elem => elem > 18).length
}
...
function mayorACien(array) {
  ...
  return newArray; */
  return newArray = array.filter(value => value > 100);
}
